...
\begin{document}
  ...
  \vspace*{-3em}
  \section{Formation}
  \cventry[0.5em]{2023-2025}{\href{http://www.ufr-info-p7.jussieu.fr/formations/masters/genial/accueil}{Master GÉNIe logiciel en ALternance (GÉNIAL)}}{}{}{}{Université Paris Cité (Paris 13ème, France) en alternance à la \href{https://sgp.fr}{Société des grands projets}}
  ...
  \begin{itemize}
    ...
    \item Réalisation de développements (PHP, Symfony, Pimcore, Java, Springboot, VueJS, React, NextJS)
  ...
  \cventry[0.5em]{2021 - 2024}{TokTok - Application Web (\href{https://toktok.actionpopulaire.fr}{toktok.actionpopulaire.fr})}{}{}{}{
    \begin{itemize}
      \setlength\itemsep{-0.5em}
      \item Lead dev et développeur frontend pour le \href{https://discord-gauche.fr/}{Discord Insoumis} (React, TypeScript, Docker, GitlLab-ci)
  ...
  \cvcomputer{Base de données}{MariaDB, PostgreSQL, MSSQL}{}{}
