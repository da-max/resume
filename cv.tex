...
\title {Développeur web freelance}
...
\begin{document}
  ...
  \cventry[0.5em]{2022}{Développeur freelance pour \href{https://ergo-art-senaux.ch}{Les Arsenaux Sàrl (ergo-art-senaux.ch)}}{}{}{}{
  \begin{itemize}
    \setlength\itemsep{-0.5em}
    \item Création d’un theme et d’un plugin Wordpress
    \item Mise en production d’un site
    \item Conseil au client
  \end{itemize}
  }
