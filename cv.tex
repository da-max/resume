...
\email{maxime.benhassen@fedabian.ch}
\photo[45pt]{photo-cv.jpg}
\homepage{fedabian.ch}
...
\begin{document}
  ...
  \cventry[0.5em]{2021 - 2025}{TokTok - Application Web (\href{https://toktok.actionpopulaire.fr}{toktok.actionpopulaire.fr})}{}{}{}{
    \begin{itemize}
      \setlength\itemsep{-0.5em}
      \item Développeur en chef pour le \href{https://discord-gauche.fr/}{Discord Insoumis} (React, NodeJS, TypeScript, Python, Django, Docker, GitlLab-ci)
